...
public class PropertiesUtility {
    ...
    private static final Logger logger = LogManager.getLogger(PropertiesUtility.class.getName());
     ...
     */
    public void loadPropertyFileForWriting() {
        try {
     ...
     */
    public void loadPropertyFileForReading() {
        try {
